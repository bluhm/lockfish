# 1 "/crypt/home/bluhm/openbsd/cvs/src/sys/netinet/ip_ah.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/crypt/home/bluhm/openbsd/cvs/src/sys/netinet/ip_ah.c"
# 39 "/crypt/home/bluhm/openbsd/cvs/src/sys/netinet/ip_ah.c"
# 1 "/crypt/home/bluhm/openbsd/cvs/src/sys/arch/amd64/compile/GENERIC/obj/pfsync.h" 1
# 40 "/crypt/home/bluhm/openbsd/cvs/src/sys/netinet/ip_ah.c" 2
...
# 42 "/crypt/home/bluhm/openbsd/cvs/src/sys/netinet/ip_ah.c" 2
...
# 43 "/crypt/home/bluhm/openbsd/cvs/src/sys/netinet/ip_ah.c" 2
...
# 44 "/crypt/home/bluhm/openbsd/cvs/src/sys/netinet/ip_ah.c" 2
...
# 45 "/crypt/home/bluhm/openbsd/cvs/src/sys/netinet/ip_ah.c" 2
...
# 47 "/crypt/home/bluhm/openbsd/cvs/src/sys/netinet/ip_ah.c" 2
...
int if_rxr_ioctl(struct if_rxrinfo *, const char *, u_int,
     struct if_rxring *);
# 48 "/crypt/home/bluhm/openbsd/cvs/src/sys/netinet/ip_ah.c" 2
...
# 49 "/crypt/home/bluhm/openbsd/cvs/src/sys/netinet/ip_ah.c" 2
...
# 51 "/crypt/home/bluhm/openbsd/cvs/src/sys/netinet/ip_ah.c" 2
...
# 52 "/crypt/home/bluhm/openbsd/cvs/src/sys/netinet/ip_ah.c" 2
...
# 53 "/crypt/home/bluhm/openbsd/cvs/src/sys/netinet/ip_ah.c" 2
...
# 56 "/crypt/home/bluhm/openbsd/cvs/src/sys/netinet/ip_ah.c" 2
...
# 59 "/crypt/home/bluhm/openbsd/cvs/src/sys/netinet/ip_ah.c" 2
# 1 "/crypt/home/bluhm/openbsd/cvs/src/sys/netinet/ip_ah.h" 1
# 41 "/crypt/home/bluhm/openbsd/cvs/src/sys/netinet/ip_ah.h"
struct ahstat
{
...
# 95 "/crypt/home/bluhm/openbsd/cvs/src/sys/netinet/ip_ah.h"
extern int ah_enable;
extern struct ahstat ahstat;
# 60 "/crypt/home/bluhm/openbsd/cvs/src/sys/netinet/ip_ah.c" 2
...
# 61 "/crypt/home/bluhm/openbsd/cvs/src/sys/netinet/ip_ah.c" 2
...
# 62 "/crypt/home/bluhm/openbsd/cvs/src/sys/netinet/ip_ah.c" 2
...
void pf_send_tcp(const struct pf_rule *, sa_family_t,
       ...
       u_int8_t, u_int16_t, u_int16_t, u_int8_t, int,
       u_int16_t, u_int);
# 65 "/crypt/home/bluhm/openbsd/cvs/src/sys/netinet/ip_ah.c" 2
...
# 66 "/crypt/home/bluhm/openbsd/cvs/src/sys/netinet/ip_ah.c" 2
...
# 69 "/crypt/home/bluhm/openbsd/cvs/src/sys/netinet/ip_ah.c" 2
...
# 70 "/crypt/home/bluhm/openbsd/cvs/src/sys/netinet/ip_ah.c" 2

# 1 "/crypt/home/bluhm/openbsd/cvs/src/sys/arch/amd64/compile/GENERIC/obj/bpfilter.h" 1
# 72 "/crypt/home/bluhm/openbsd/cvs/src/sys/netinet/ip_ah.c" 2
...
# 296 "/crypt/home/bluhm/openbsd/cvs/src/sys/netinet/ip_ah.c"
    if (out)
    ...
    int protoff)
{
 ...
 tdb->tdb_rpl++;
 ah->ah_rpl = __extension__({ __uint32_t __swap32_x = ((u_int32_t)(tdb->tdb_rpl & 0xffffffff)); __builtin_constant_p((u_int32_t)(tdb->tdb_rpl & 0xffffffff)) ? __extension__({ __uint32_t __swap32gen_x = (__swap32_x); (__uint32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); }) : __extension__({ __uint32_t __swap32md_x = (__swap32_x); __asm ("bswap %0" : "+r" (__swap32md_x)); __swap32md_x; }); });
 ...
 case 2:
  memcpy((caddr_t) &iplen, ((caddr_t)(tc + 1)) +
      __builtin_offsetof(struct ip, ip_len), sizeof(u_int16_t));
  iplen = __extension__({ __uint16_t __swap16_x = (__extension__({ __uint16_t __swap16_x = (iplen); __builtin_constant_p(iplen) ? __extension__({ __uint16_t __swap16gen_x = (__swap16_x); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : __extension__({ __uint16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w0" : "+r" (__swap16md_x)); __swap16md_x; }); }) + rplen + ahx->authsize); __builtin_constant_p(__extension__({ __uint16_t __swap16_x = (iplen); __builtin_constant_p(iplen) ? __extension__({ __uint16_t __swap16gen_x = (__swap16_x); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : __extension__({ __uint16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w0" : "+r" (__swap16md_x)); __swap16md_x; }); }) + rplen + ahx->authsize) ? __extension__({ __uint16_t __swap16gen_x = (__swap16_x); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : __extension__({ __uint16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w0" : "+r" (__swap16md_x)); __swap16md_x; }); });
 ...
 case 24:
  memcpy((caddr_t) &iplen, ((caddr_t)(tc + 1)) +
      __builtin_offsetof(struct ip6_hdr, ip6_ctlun.ip6_un1.ip6_un1_plen), sizeof(u_int16_t));
  iplen = __extension__({ __uint16_t __swap16_x = (__extension__({ __uint16_t __swap16_x = (iplen); __builtin_constant_p(iplen) ? __extension__({ __uint16_t __swap16gen_x = (__swap16_x); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : __extension__({ __uint16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w0" : "+r" (__swap16md_x)); __swap16md_x; }); }) + rplen + ahx->authsize); __builtin_constant_p(__extension__({ __uint16_t __swap16_x = (iplen); __builtin_constant_p(iplen) ? __extension__({ __uint16_t __swap16gen_x = (__swap16_x); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : __extension__({ __uint16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w0" : "+r" (__swap16md_x)); __swap16md_x; }); }) + rplen + ahx->authsize) ? __extension__({ __uint16_t __swap16gen_x = (__swap16_x); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }) : __extension__({ __uint16_t __swap16md_x = (__swap16_x); __asm ("rorw $8, %w0" : "+r" (__swap16md_x)); __swap16md_x; }); });
