# 1 "/crypt/home/bluhm/openbsd/cvs/src/sys/net/pfkeyv2.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/crypt/home/bluhm/openbsd/cvs/src/sys/net/pfkeyv2.c"
# 71 "/crypt/home/bluhm/openbsd/cvs/src/sys/net/pfkeyv2.c"
# 1 "/crypt/home/bluhm/openbsd/cvs/src/sys/arch/amd64/compile/GENERIC/obj/pf.h" 1
# 72 "/crypt/home/bluhm/openbsd/cvs/src/sys/net/pfkeyv2.c" 2
...
struct tty;
struct uio;
# 74 "/crypt/home/bluhm/openbsd/cvs/src/sys/net/pfkeyv2.c" 2
...
# 75 "/crypt/home/bluhm/openbsd/cvs/src/sys/net/pfkeyv2.c" 2
...
# 76 "/crypt/home/bluhm/openbsd/cvs/src/sys/net/pfkeyv2.c" 2
...
# 77 "/crypt/home/bluhm/openbsd/cvs/src/sys/net/pfkeyv2.c" 2
...
# 78 "/crypt/home/bluhm/openbsd/cvs/src/sys/net/pfkeyv2.c" 2
...
# 79 "/crypt/home/bluhm/openbsd/cvs/src/sys/net/pfkeyv2.c" 2
...
# 80 "/crypt/home/bluhm/openbsd/cvs/src/sys/net/pfkeyv2.c" 2
...
# 81 "/crypt/home/bluhm/openbsd/cvs/src/sys/net/pfkeyv2.c" 2
...
# 83 "/crypt/home/bluhm/openbsd/cvs/src/sys/net/pfkeyv2.c" 2
...
# 84 "/crypt/home/bluhm/openbsd/cvs/src/sys/net/pfkeyv2.c" 2
...
# 86 "/crypt/home/bluhm/openbsd/cvs/src/sys/net/pfkeyv2.c" 2
...
# 87 "/crypt/home/bluhm/openbsd/cvs/src/sys/net/pfkeyv2.c" 2
...
# 88 "/crypt/home/bluhm/openbsd/cvs/src/sys/net/pfkeyv2.c" 2
# 1 "/crypt/home/bluhm/openbsd/cvs/src/sys/crypto/blf.h" 1
# 50 "/crypt/home/bluhm/openbsd/cvs/src/sys/crypto/blf.h"
...
# 89 "/crypt/home/bluhm/openbsd/cvs/src/sys/net/pfkeyv2.c" 2
...
# 92 "/crypt/home/bluhm/openbsd/cvs/src/sys/net/pfkeyv2.c" 2
...
void pf_send_tcp(const struct pf_rule *, sa_family_t,
       ...
       u_int8_t, u_int16_t, u_int16_t, u_int8_t, int,
       u_int16_t, u_int);
# 93 "/crypt/home/bluhm/openbsd/cvs/src/sys/net/pfkeyv2.c" 2





static struct pfkeyv2_socket *pfkeyv2_sockets = ((void *)0);
...
pfkeyv2_create(struct socket *socket)
{
 ...
 pfkeyv2_socket->pid = (&cpu_info_primary)->ci_curproc->p_p->ps_pid;





 pfkeyv2_socket->rdomain = rtable_l2((&cpu_info_primary)->ci_curproc->p_p->ps_rtableid);
...
pfkeyv2_send(struct socket *socket, void *message, int len)
{
 ...
 struct pfkeyv2_socket *pfkeyv2_socket, *so = ((void *)0);
 ...
 if (npromisc) {
  ...
  smsg->sadb_msg_len = (sizeof(struct sadb_msg) + len) /
      sizeof(uint64_t);
  smsg->sadb_msg_seq = (&cpu_info_primary)->ci_curproc->p_p->ps_pid;
...
{
 void *p, *headers[34 + 1], *buffer = ((void *)0);
    ...
    int *lenp)
{
 ...
 perm = suser((&cpu_info_primary)->ci_curproc, 0);
    ...
    void *new, size_t newlen)
{
 ...
 rdomain = rtable_l2((&cpu_info_primary)->ci_curproc->p_p->ps_rtableid);

 switch(w.w_op) {
 case 1:
  if ((error = suser((&cpu_info_primary)->ci_curproc, 0)) != 0)
   return (error);
  s = splraise(0x5);
